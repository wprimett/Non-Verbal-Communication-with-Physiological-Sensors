...
\AtEveryBibitem{\clearfield{urlyear}\clearfield{urlmonth}\clearfield{urlday}\clearlist{publisher}\clearfield{note}\clearfield{url}}
\AtEveryCitekey{\clearfield{urlyear}\clearfield{urlmonth}\clearfield{urlday}\clearlist{publisher}\clearfield{note}\clearfield{url}}
...
\title[Non-verbal Communication \\with Physiological Sensors: The Aesthetic Domain of Wearables and Neural Networks]{Non-Verbal Communication Using Physiological Sensors}
\subtitle{Designing Embodied Systems for Expressive, Speechless Dialogue}

% Autor
% use [f] for female and [m] for male
\authorname[m]{William Ruddock Primett}{William Primett}
...
% use [f] for female and [m] for male
\adviser[f]{Hugo Plácido da Silva}{Full Professor}{IST University of Lisbon} 
...
% use [f] for female and [m] for male
\coadviser[f]{Hugo Gamboa}{Full Professor}{NOVA University of Lisbon}
...
\committee[c,m]{José Paulo Santos}
% Main raporteurs
